...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=1e-4,
                        help='Learning rate.')
    parser.add_argument('--r_decay', type=float, default=1e-4,
                        help='Learning rate.')

    # ------------------------- experimental settings specific for sampler --------------------------------------------
    parser.add_argument('--policy_type', nargs='?', default='uj', help='policy function type: uj, uij')
    parser.add_argument('--s_decay', type=float, default=1e-4,
                        help='Learning rate.')
